...
import serviceConfirm from 'view/services/serviceConfirm';
import serviceAlert from 'view/services/serviceAlert';
...
import serviceItemInfoInit from "view/services/serviceItemInfo";
import serviceCryptoInit from "view/services/crypto";
...
export default function createViewContext(
    ...
    const newContext = {
        ...
        services: {
            ...
            confirm: serviceConfirm(modalSystem),
            alert: serviceAlert(modalSystem),
            menu: serviceMenu(modalSystem),
            itemInfo: serviceItemInfoInit(refContext),
            crypto: serviceCryptoInit(refContext)
        },
