...
import { IconOnOff, IconMenu, IconCharacter, IconWorld } from 'view/components/icon';
import featureMenu from './features/menu';
...
> {
    ...
    onClickPackage = () => {
        ...
        for (let packageObject of markersState.packages) {
            ...
            switch (packageObject.type) {
                ...
                case "url": {
                    icon = (
                        <span className="mr-4"><IconWorld /></span>
                    );
                } break;
            }
    ...
    onClickBtnMenu = () => {
        featureMenu(this.props.context);
    }
    ...
    render(): JSX.Element {
        ...
        const btnOffClass = rootMarker.color1.active ? 'btn-success' : 'btn-dark';

        const onClickBtnColorActive = () => {
            worldStore.actions.markerSetColorActive(
                rootMarker.uuid,
                !rootMarker.color1.active
            );
        };
                    ...
                    <div className="marker-header value-format p-2">
                        ...
                        <div className="btn-group ifx-as">
                            <button
                                ...
                                style={{
                                    'backgroundColor': rootMarker.color1.value
                                }}
                                onClick={(e) => {
                                    cPick(
                                        rootMarker.color1.value,
                                        (color) => {}
                                    ).promise.then(
                                        (color) => {
