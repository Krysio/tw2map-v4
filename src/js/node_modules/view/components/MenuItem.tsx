...
extends React.Component<ComponentProps, ComponentState> {
    ...
    componentWillMount(): void {
        ...
        events.on('map/move', this.onSomething);
    }
    ...
    componentWillUnmount(): void {
        ...
        events.removeListener('map/move', this.onSomething);
    }
    ...
    render(): JSX.Element {
        ...
        if (this.village !== null) {
            ...
            markButtons.push(
                ...
                >
                    <FontAwesomeIcon icon="flag" /> { name } [{ x }|{ y }]
                </a>
            );
            infoButtons.push(
                <a
        ...
        if (this.character !== null) {
            markButtons.push(
                ...
                >
                    <FontAwesomeIcon icon="user" /> { this.character.name }
                </a>
            );
            infoButtons.push(
                <a
        ...
        if (this.tribe !== null) {
            markButtons.push(
                ...
                >
                    <FontAwesomeIcon icon="asterisk" /> { this.tribe.name }
                </a>
            );
            infoButtons.push(
                <a
        ...
        return (
            <div className="dropdown-menu show position-static">
                <h6 className="dropdown-header">Mark</h6>
                { markButtons }
                <h6 className="dropdown-header">Info</h6>
                { infoButtons }
            </div>
        );
    }
