...
> {
    ...
    componentWillMount(): void {
        ...
        events.on('map/leave', this.onMapLeave);
        events.on('map/enter', this.onMapLeave);
    ...
    componentWillUnmount(): void {
        ...
        events.removeListener('map/leave', this.onMapLeave);
        events.removeListener('map/enter', this.onMapLeave);
