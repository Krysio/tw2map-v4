...
extends React.Component<ComponentProps, ComponentState> {
    ...
    constructor(props) {
        super(props);
        this.appContext = createViewContext(this.props.context);
        this.serviceColorPicker = serviceColorPickerInit(this.appContext.modalSystem);
        this.featureSettings = featureSettingsInit(
            this.appContext.modalSystem,
            this.appContext.stores,
            this.appContext.mainCanvas,
        ...
        this.featureMarkers = featureMarkersInit(
            this.appContext.modalSystem,
            this.appContext.mainCanvas,
            this.appContext.stores
        );
    ...
    render(): JSX.Element {
        let MM = this.appContext.modalSystem,
            stores = this.appContext.stores;
                ...
                <Router>
                    ...
                    <Route exact path="/:market" render={(routeProps) => {
                        ...
                        <pre style={{color: 'white'}}>
                            { JSON.stringify(routeProps, null, ' ') }
                        </pre>
                    }} />
    ...
    pageList(
        ...
        return React.createElement(
            ...
            {
                ...routeProps,
                modalSystem: this.appContext.modalSystem,
    ...
    pageMap(
        ...
        return React.createElement(
            ...
            {
                ...routeProps,
                mainCanvas: this.appContext.mainCanvas,
                mapData: this.appContext.data,
                stores: this.appContext.stores,
                modalSystem: this.appContext.modalSystem,
