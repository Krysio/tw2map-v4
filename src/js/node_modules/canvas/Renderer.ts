...
import { BUFF_DATA_ELEMENTS_PER_TILE } from "./data/BuffersManager";
...
export default class Renderer {
    ...
    initUniforms() {
        ...
        this.setSize(this.uniformValue.size);
        this.setPosition(...this.uniformValue.position as [number, number]);
    ...
    setPosition(
        ...
        if (!this.shaderProgram) {
            this.uniformValue.position = [valueX, valueY];
