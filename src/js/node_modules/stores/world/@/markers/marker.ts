...
export function createMarker(
    ...
    return {
        ...
        active: true,
        listVisible: true,
        color1: {value: color, active: true},
        color2: {value: '#000000ff', active: false},
        color3: {value: '#000000ff', active: false},
    };
}
...
const MarkerPrototype = {
    ...
    getColor(
        ...
        if (parentColor === null) {
            if (this[`color${ colorIndex }`].active) {
                return {
                    value: this[`color${ colorIndex }`].value,
                    index: this.index,
                    uuid: this.uuid
                };
            }
