    ...
    switch (action.type) {
        case 'command/import': {
            ...
            try {
                ...
                /** FIX */
                for (let pkg of data.markers.packages) {
                    for (let marker of pkg.markers) {
                        if (!marker.color1) {
                            marker.color1 = {value: '#00000000', active: 0};
                            marker.color2 = {
                                active: marker.colorActive,
                                value: marker.colorValue+'ff'
                            };
                            marker.color3 = {
                                active: marker.colorActive,
                                value: marker.colorValue+'ff'
                ...
                for (let colorKey in data.mapColors) {
                    ...
                    if (typeof data.mapColors[ colorKey ] === 'string') {
                        data.mapColors[ colorKey ] = {active: true, value: data.mapColors[ colorKey ]};
                    }
                }
                /** FIX */
